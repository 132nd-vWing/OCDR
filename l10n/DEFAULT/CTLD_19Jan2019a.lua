...
ctld.maxExtractDistance = 300 -- max distance from vehicle to troops to allow a group extraction
ctld.maximumDistanceLogistic = 200 -- max distance from vehicle to logistics to allow a loading or spawning operation
ctld.maximumSearchDistance = 10 -- max distance for troops to search for enemy
ctld.maximumMoveDistance = 10 -- max distance for troops to move from drop point if no enemy is nearby
...
ctld.dropOffZones = {
    { "FieldHospital", "none", 2 },
    { "SochiCotrolTower", "none", 2 },
    { "SochiFuelTanks", "none", 2 },
    { "LZ-1", "none", 2 },
    { "LZ-2", "none", 2 },
    { "dropzone6", "none", 1 },
    { "dropzone7", "none", 1 },
